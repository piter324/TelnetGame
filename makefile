...
all: AutorizationController.o AdminController.o Response.o Room.o FileHandler.o RoomController.o server.o
	$(CC) AutorizationController.o AdminController.o Response.o Room.o FileHandler.o RoomController.o server.o -o server
	rm *.o
